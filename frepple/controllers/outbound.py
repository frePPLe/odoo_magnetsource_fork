...
class exporter(object):
    ...
    def export_items(self):
        ...
        for i in self.generator.getData(
            ...
            warehouse_tmp = tmpl["x_frepple_warehouse"]
            # a comma-separated string with the names of the warehouses
            warehouse = None
            ...
            for product_id in product_template["product_variant_ids"]:
                ...
                for subcontractor in subcontractors:
                    ...
                    if (
                        ...
                        # routing step.
                        #
                        yield '<operation name=%s posttime="P%dD" priority="%s" xsi:type="operation_routing"><item name=%s/><location name=%s/>\n' % (
                            quoteattr(operation),
                            self.manufacturing_lead,
                            100 + (i["sequence"] or 1),
                            quoteattr(product_buf["name"]),
            ...
            for i in self.generator.getData(
                ...
                search=[
                    ...
                    (
                        ...
                        ("draft", "bid", "to approve", "confirmed", "cancel"),
